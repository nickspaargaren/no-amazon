...
1. Log in to your [Pi-hole](https://pi-hole.net) admin interface
2. Navigate to **Lists** → **Add a new subscribed list**
3. Add the following URL:
   ```
   https://raw.githubusercontent.com/nickspaargaren/no-amazon/refs/heads/master/amazon.txt
   ```
4. Click **Add blocklist** and then update your gravity list: **Tools** → **Update Gravity**

### AdGuard / AdGuard Home

1. Open your [AdGuard](https://adguard-dns.io/kb/adguard-home/overview/) settings
2. Navigate to **Filters** → **DNS blocklists** → **Add blocklist** → **Add a custom list**
3. Add the following URL:
   ```
   https://raw.githubusercontent.com/nickspaargaren/no-amazon/refs/heads/master/amazon-adguard.txt
   ```
